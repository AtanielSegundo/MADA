...
def generatePathRaw(n_clusters:int,forma:List[np.ndarray],distance:float,seed:bool,runs:int=5,save_fig_path=None,fliped_y=False) -> Tuple[exec_time,path_lenght,angle_delta]:
    LKH_PATH = "LKH.exe"
    SEED     = seed
    DISTANCE = distance
    BORDERS_DISTANCE = 0
